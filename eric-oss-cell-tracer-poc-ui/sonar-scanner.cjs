...
scanner(
  {
    ...
    options: {
      ...
      'sonar.projectKey': process.env.SONAR_PROJECT_KEY || 'com.ericsson.oss.predev:eric-oss-cell-tracer-poc-ui',
      'sonar.projectName': process.env.SONAR_PROJECT_NAME || 'eric-oss-cell-tracer-poc-ui',
