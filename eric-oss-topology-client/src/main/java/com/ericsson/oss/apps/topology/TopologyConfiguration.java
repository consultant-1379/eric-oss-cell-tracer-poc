...
public class TopologyConfiguration {
    ...
    @Bean
    public TopologyService topologyService(CtsRestClient ctsRestClient, CmHandleResolver cmHandleResolver) {
        return new TopologyService(ctsRestClient, cmHandleResolver);
    }
}
