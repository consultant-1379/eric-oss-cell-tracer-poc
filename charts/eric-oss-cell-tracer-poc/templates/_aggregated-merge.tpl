...
*/ -}}
{{- define "eric-oss-cell-tracer-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-cell-tracer-poc.mergeAnnotations" -}}
  {{- include "eric-oss-cell-tracer-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-cell-tracer-poc.mergeLabels" -}}
  {{- include "eric-oss-cell-tracer-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
